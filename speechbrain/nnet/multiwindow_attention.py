...
class WindowedAttentionHead(nn.Module):
    def __init__(
        ...
        self.relative_position_bias_table = nn.Parameter(
            torch.zeros(2 * self.window_size - 1, 1)
        )
    ...
    def forward(self, q, k, v, key_padding_mask=None, attn_fill_value=-65000):
        ...
        if key_padding_mask is not None:
            ...
            key_padding_mask_windowed = key_padding_mask.reshape(
                B, W // self.window_size, self.window_size, 1
            )
            key_padding_mask_windowed = key_padding_mask_windowed.reshape(
